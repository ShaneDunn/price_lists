...
function loadTemplateISC(sysConfig,config) {
  ...
  for (var i=0; i < numRows; i++) {
    ...
    if (sheetData[i][0] === '' ) {
      ...
      if (active) {
        var v_DomainCode         = sysConfig.domain_code    // Item Site Cost Keys/     /Domain
        var v_CostSet            = "Standard"               //                    /     /Cost Set
        var v_ItemCode           = String(sheetData[i][20]) //                    /     /Item
        var v_SiteCode           = sysConfig.site           //                    /     /Site
        var v_rowData            = ""                       //                    /     /Row Data
        ...
        v_DomainCode         = ""                       // Item Site Cost Keys/     /Domain
        v_CostSet            = ""                       //                    /     /Cost Set
        v_ItemCode           = ""                       //                    /     /Item
        v_SiteCode           = ""                       //                    /     /Site
        v_rowData            = ""                       //                    /     /Row Data
        ...
        v_DomainCode         = sysConfig.domain_code    // Costs              /Costs/Domain
        v_CostSet            = "Standard"               //                    /     /Cost Set
        v_ItemCode           = String(sheetData[i][20]) //                    /     /Item Number
        v_SiteCode           = sysConfig.site           //                    /     /Site
        v_CostElement        = "Material"               //                    /     /Element
        v_CostCategory       = ""                       //                    /     /Category
        v_ThisLevelCost      = sheetData[i][16]         //                    /     /This Level
        v_LowerLevelCost     = ""                       //                    /     /Lower Level
        v_TotalCost          = ""                       //                    /     /Total
        v_IsPrimary          = "Yes"                    //                    /     /Primary
        v_IsAddOn            = "No"                     //                    /     /Add On
